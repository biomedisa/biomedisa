...
+ [Windows 10 + OpenCL + GPU (easy install but lacks features like allaxis, smoothing, GPU memory optimization)](https://github.com/biomedisa/biomedisa/blob/master/README/windows10_opencl_gpu_cli.md)
