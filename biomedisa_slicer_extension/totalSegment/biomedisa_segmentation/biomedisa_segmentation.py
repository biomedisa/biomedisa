...
#
# biomedisa_segmentation
#


class biomedisa_segmentation(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("biomedisa")  # TODO: make this more human readable by adding spaces
...
def registerSampleData():
    ...
    # biomedisa_segmentation1
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category="biomedisa_segmentation",
        sampleName="biomedisa_segmentation1",
        # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
        # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
        thumbnailFileName=os.path.join(iconsPath, "biomedisa_segmentation1.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames="biomedisa_segmentation1.nrrd",
        # Checksum to ensure file integrity. Can be computed by this command:
        #  import hashlib; print(hashlib.sha256(open(filename, "rb").read()).hexdigest())
        checksums="SHA256:998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        # This node name will be used when the data set is loaded
        nodeNames="biomedisa_segmentation1",
    )

    # biomedisa_segmentation2
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category="biomedisa_segmentation",
        sampleName="biomedisa_segmentation2",
        thumbnailFileName=os.path.join(iconsPath, "biomedisa_segmentation2.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames="biomedisa_segmentation2.nrrd",
        checksums="SHA256:1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        # This node name will be used when the data set is loaded
        nodeNames="biomedisa_segmentation2",
    )


#
# biomedisa_segmentationParameterNode
#


@parameterNodeWrapper
class biomedisa_segmentationParameterNode:
    """
...
#
# biomedisa_segmentationWidget
#


class biomedisa_segmentationWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath("UI/biomedisa_segmentation.ui"))
        ...
        self.ui.labelSelector.nodeTypes = ["vtkMRMLLabelMapVolumeNode"]

        # Create logic class. Logic implements all computations that should be possible to run
        # in batch mode, without a graphical user interface.
        self.logic = biomedisa_segmentationLogic()
    ...
    def initializeParameterNode(self) -> None:
        ...
        if not self._parameterNode.inputVolume:
            ...
            firstLabelNode = slicer.mrmlScene.GetFirstNodeByClass("vtkMRMLLabelMapVolumeNode")
            if firstLabelNode:
                self._parameterNode.inputLabels = firstLabelNode
            

    def setParameterNode(self, inputParameterNode: Optional[biomedisa_segmentationParameterNode]) -> None:
        """
    ...
    def onApplyButton(self) -> None:
        ...
        #inputNode =   slicer.util.getNode('tumor')
        ...
        #import SampleData
        #inputVolume = SampleData.downloadSample("biomedisa_segmentation1")
        #labels  = SampleData.downloadSample("biomedisa_segmentation1")

        outputImage = biomedisa_segmentationLogic.process(input=inputImage, 
                                                          labels=labels, 
                                                          sorw=self._parameterNode.sorw, 
                                                          nbrw=self._parameterNode.nbrw)

        #outputVolume = self._parameterNode.outputLabels 
        ...
        #self._parameterNode.outputLabels = outputVolume
        #slicer.util.setNode('labels.tumor', outputVolume)
...
#        # load data
#        img, _ = load_data("C:\\Users\\matze\\Documents\\Code\\biomedisa\\media\\tumor.tif")
#        labels, header = load_data("C:\\Users\\matze\\Documents\\Code\\biomedisa\\media\\labels.tumor.tif")
#        # smart interpolation with optional smoothing result
#        results = smart_interpolation(img, labels, nbrw=1, sorw=1)#, smooth=100, platform="opencl_AMD_GPU")
#        # get results
#        regular_result = results['regular']


#
# biomedisa_segmentationLogic
#


class biomedisa_segmentationLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return biomedisa_segmentationParameterNode(super().getParameterNode())
    ...
    def process(
        ...
        """
        # convert data
        numpyImage = biomedisa_segmentationLogic.vtkToNumpy(input)
        numpyLabels = biomedisa_segmentationLogic.vtkToNumpy(labels)
        ...
        # convert back
        outputImage = biomedisa_segmentationLogic.numpyToVTK(regular_result)
        return outputImage

#
# biomedisa_segmentationTest
#


class biomedisa_segmentationTest(ScriptedLoadableModuleTest):
    """
    ...
    def runTest(self):
        ...
        self.setUp()
        self.test_biomedisa_segmentation1()

    def test_biomedisa_segmentation1(self):
        ...
        logic = biomedisa_segmentationLogic()
